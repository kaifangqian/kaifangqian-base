<script>
	...
	export default defineComponent({
		name: 'mian',
		components:{
			Button,Input,Divider,RadioGroup,RadioButton,Space,Tooltip,Form,FormItem,Modal,CloseCircleOutlined,
			QuestionCircleOutlined,draggable,ControlItem,SealModal,SignatureModal,Spin,CheckCircleOutlined
		},
		setup() {
			...
			return{
				...
				successVisible,errorVisible,errorMsg,CloseCircleOutlined
			}
		}
	})
</script>
	...
	<Modal v-model:visible="successVisible" @ok="handleOk" cancelText="关闭" :footer="null">
		<div class="modal-title">
			<Space :size="10">
				...
				<span>文档签署成功，自动下载签署文件</span>
			</Space>
		</div>
		<div class="modal-body">
			<p>1、可使用adobe软件打开文件，查看文件中的签章信息</p>
			<p>2、可进入到“开放签”官网进行验签<a href="https://www.kaifangqian.com/#/verification" target="_blank" style="margin-left:10px">去验签</a></p>
		</div>
